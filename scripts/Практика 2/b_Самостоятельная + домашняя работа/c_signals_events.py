...
from ui import c_signals_events
import time
...
class Window(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        self.ui.pushButtonMoveCoords.clicked.connect(self.editPosition)
    ...
    def editPosition(self):
        ...
        position = {"Лево/Верх":(0, 0),
                    ...
                    "Переместить": (self.ui.spinBoxX.value(), self.ui.spinBoxY.value())}
